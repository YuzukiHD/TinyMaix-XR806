        ...
        // Can be used for evaluating a HEAD request
{
        ...
        do
        {
                ...
                memcpy(RequestCmd + pHTTPSession->HttpCounters.nSentHeaderBytes,HTTP_CLIENT_CRLF,nBytes);
...
UINT32 HTTPIntrnAuthSendBasic (P_HTTP_SESSION pHTTPSession)
{
        ...
        do
        {
                        ...
                        case( HTTP_STATUS_UNAUTHORIZED): // For host authentication
                                {
                                        ...
                                        memcpy(pHTTPSession->HttpCredentials.ToSendAuthInfo.pParam,INITIAL_HDR,nbytes);
#endif
                                        // Convert to base 64
                ...
                memcpy(pHTTPSession->HttpCredentials.ToSendAuthInfo.pParam + tbytes,HTTP_CLIENT_CRLF,nbytes);
                tbytes += nbytes;
...
UINT32 HTTPIntrnAuthSendDigest (P_HTTP_SESSION pHTTPSession)
{
                ...
                case( HTTP_STATUS_UNAUTHORIZED): // For host authentication
                        {
                                ...
                                memcpy(pParam,INITIAL_HDR,nbytes);
                                pParam += nbytes;
#endif
        ...
        do
        {
                ...
                memcpy(pParam,REALEM_HDR,nbytes);
                tbytes += nbytes;
                pParam += nbytes;
#endif
                ...
                memcpy(pParam,NONCE_HDR,nbytes);
                tbytes += nbytes;
                pParam += nbytes;
#endif
                // "Authorization: Digest username="username", realm="myRealm", qop="auth",
                ...
                memcpy(pParam,HTTP_CLIENT_CRLF,nbytes);
                tbytes += nbytes;
